...
import { $which, isEnoent, VERSION } from "@oh-my-pi/pi-utils";
...
const PACKAGE = "@sns-myagent/cli";
const HOMEBREW_FORMULA = "can1357/tap/omp";
const MISE_TOOL = "github:Reihantt6/sns-myagent";
/**
 ...
 * `@sns-myagent/cli` and the loader aborts at
