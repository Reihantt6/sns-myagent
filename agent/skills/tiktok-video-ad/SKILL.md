---
description: "Create native TikTok video ads with Pexo — vertical 9:16, sound-on, hook-first. Give it your product and Pexo writes the script in TikTok's voice, sequences fast-paced shots, picks the models, and delivers a ready-to-post ad with trending-style music. Use for TikTok ads: \"tiktok ad\", \"tiktok video ad\", \"ad for tiktok\", \"vertical video ad\". NOT for landscape or long-form ads (use the video-ad skill).\n"
metadata: {"author":"pexoai"}
---
# TikTok Video Ad — Pexo

**Pexo:** https://pexo.ai — get an API key, watch your project render, and buy credits there.

Produce a native, ready-to-post TikTok ad — vertical and hook-first. You relay the user's
product or brief to the hosted Pexo agent and deliver the result; Pexo writes the TikTok-style
script, sequences the shots, and sets the pacing and sound.
...
User: "Make a TikTok ad for our skincare serum."

```bash
pid=$(pexo-project-create.sh "skincare serum TikTok ad")
pexo-chat.sh "$pid" "Make a TikTok ad for our skincare serum."
